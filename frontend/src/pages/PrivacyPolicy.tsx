            ...
            <div className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto relative z-10">
                ...
                <GlassCard className="p-8 text-gray-200">
                    <div className="space-y-12">
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-white mb-4">2. Сроки хранения и цели обработки данных</h2>
                            <p>
                                В целях обеспечения безопасности, предотвращения мошенничества и выявления повторных регистраций (мультиаккаунтов), сервис устанавливает следующие регламенты:
                            </p>
                            <ul className="list-disc pl-6 mt-2 space-y-1">
                                <li>
                                    <strong className="text-white">Данные учетных записей и параметры устройств:</strong> Сведения о профиле, технические характеристики устройства (Hardware ID / User-Agent) и история IP-адресов обрабатываются в течение всего периода существования проекта для обеспечения стабильной работы систем защиты.
                                </li>
                                <li>
                                    <strong className="text-white">Данные античита:</strong> Полные дампы логов удаляются автоматически через 14 дней. Обезличенные технические маркеры могут сохраняться на более длительный срок для обучения нейросети античита.
                                </li>
                                <li>
                                    <strong className="text-white">Право на удаление:</strong> В соответствии с применимым законодательством (включая принципы GDPR), пользователь имеет право запросить полное удаление своих персональных данных через официальные каналы поддержки (Discord / Email). Администрация обязуется удалить или безвозвратно анонимизировать данные в течение 30 дней со дня получения запроса, за исключением случаев, когда сохранение частичной технической информации (хеш-сумм девайсов или заблокированных IP) строго необходимо для предотвращения повторных нарушений и обеспечения безопасности инфраструктуры.
                                </li>
                            </ul>
                        </section>
