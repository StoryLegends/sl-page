        ...
        <div className={`${baseStyles} ${variants[variant]} ${className}`}>
            {variant === 'highlight' && (
                <>
                    ...
                    <div className="absolute -top-10 -right-10 w-32 h-32 bg-story-gold/20 rounded-full blur-3xl group-hover:bg-story-gold/30 transition-colors" />
                    <div className="absolute -bottom-10 -left-10 w-32 h-32 bg-legends-blue/20 rounded-full blur-3xl group-hover:bg-legends-blue/30 transition-colors" />
                </>
            )}
