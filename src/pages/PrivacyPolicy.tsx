                    ...
                    <div className="space-y-12">
                        <section>
                            ...
                            <ul className="list-disc pl-6 mt-2 space-y-1">
                                ...
                                <li><strong>Данные системы античита:</strong> Техническая информация о запущенном софте и процессах, собираемая для выявления подозрительных данных исключительно в целях обеспечения безопасности, борьбы с читерством и расследования инцидентов. Эти данные также могут использоваться для обучения нейросети античита (при этом конфиденциальные данные удаляются, а логи обезличиваются). Доступ к исходным данным имеют только администраторы.</li>
                            </ul>
                            <p className="mt-2">
                        ...
                        <section>
                            ...
                            <ul className="list-disc pl-6 mt-2 space-y-1">
                                ...
                                <li>
                                    <strong className="text-white">Данные античита:</strong> Полные данные удаляются автоматически через 14 дней. Обезличенные логи могут сохраняться на более длительный срок для обучения нейросети античита.
                                </li>
                                <li>
